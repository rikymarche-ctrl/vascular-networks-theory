...
\newcommand{\ParamB}{1930}                         % [W/m³    ] Metabolic cost per unit blood volume
...
% --------------------------------------------------------------------
\newcommand{\AlphaStarLow}{2.945}                  % [-       ] Optimum branching exponent at MW_LOW
\newcommand{\AlphaStarMid}{2.909}                  % [-       ] Optimum branching exponent at MW_MID
\newcommand{\AlphaStarHigh}{2.900}                 % [-       ] Optimum branching exponent at MW_HIGH
\newcommand{\RstarLow}{1.175}                      % [mm      ] Optimum parent radius at MW_LOW
\newcommand{\RstarMid}{1.010}                      % [mm      ] Optimum parent radius at MW_MID
\newcommand{\RstarHigh}{0.933}                     % [mm      ] Optimum parent radius at MW_HIGH
...
\newcommand{\DeltaAlphaOurs}{0.21}                 % [-       ] Remaining Discrepancy: Our model vs. Empirical mean
\newcommand{\AlphaScaleRange}{0.014}               % [-       ] Variation of $\alpha^*$ over 4 decades of flow scale
