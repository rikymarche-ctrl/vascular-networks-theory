...
$FinalName       = "The Incommensurability Principle in Biological Transport (Clean Copy).pdf"
$FinalSuppName   = "Supplemental Material - The Incommensurability Principle (Clean Copy).pdf"
...
Write-Host "`n== CLEAN BUILD COMPLETE! Clean copies in output\ (suffix '(Clean Copy)') ==" -ForegroundColor Green
