<#
.SYNOPSIS
    Builds the Paper 4 manuscript deterministically from scratch.
.DESCRIPTION
    1. Executes compute.py to generate dynamic_variables.tex.
...
try {
    ...
    if (Test-Path "main.pdf") {
        try {
            ...
            Write-Host "`n ERRORE DI SPOSTAMENTO: chiudi il PDF reader e riprova." -ForegroundColor Red
        }
    } else {
