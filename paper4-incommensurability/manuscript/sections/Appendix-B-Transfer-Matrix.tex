...
\chA{supports} the validity of the first-order truncation in physiological
regimes.
...
wave simulations (Paper~II~\cite{paperII}) \chA{show} that the incoherent
geometric penalty provides an accurate representation of mean reflection losses,
with deviation $\langle |\Delta\alpha^*| \rangle < 0.01$ across physiological
parameter ranges.
