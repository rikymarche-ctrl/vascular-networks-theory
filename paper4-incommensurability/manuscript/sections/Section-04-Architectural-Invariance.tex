...
theorem~\cite{sion1958}\chA{, whose quasi-convexity hypothesis is satisfied
\emph{a fortiori} by this convexity}, a saddle point
...
\mathcal{C}_{\mathrm{transport}}^{\mathrm{net}}(\alpha^*)$. \chRB{This is the
formal counterpart of the game intuition above: at the saddle the adversary is
indifferent to $\eta$ precisely because the two costs coincide, so the
$\eta$-derivative vanishes and the equal-cost condition follows automatically.}
This equivalence
...
$\eta$. \chA{We establish the stronger property that $\mathcal{C}_{\mathrm{wave}}$
is \emph{convex} over the physiological range---which implies the quasi-convexity
Sion requires---through the following} physical and numerical arguments:
...
$\mathcal{L}_{\mathrm{net}}(\alpha,\eta)$ is convex in $\alpha$; Sion's
quasi-convexity requirement is therefore met \emph{a fortiori},} ensuring
existence of the saddle point. The
