...
Paper~II~\cite{paperII}. (\chA{Here} $\alpha_w = \VarAlphaW$ is the theoretical
...
incommensurability mechanism from material-specific corrections. \chE{The} wall
...
Table~\ref{tab:sensitivity} \chA{supports} this numerically on the porcine
...
length $\ell_0$) show $|S_x| < 0.01$, \chA{supporting} metabolic gauge invariance
