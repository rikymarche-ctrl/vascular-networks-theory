...
incommensurability mechanism from material-specific corrections. Note that the
...
(Theorem~\ref{thm:gauge}). \textbf{Structural and fluid-mechanical parameters}
...
saddle point at duty cycle $\eta^*\approx\VarEtaStar$, stabilised by
evolutionary selection pressure from both extremes. The duty cycle $\eta$ and
