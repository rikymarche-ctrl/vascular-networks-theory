...
structural parameters $(G, N, p, \alpha_w, A)$ and is \chE{independent, within numerical sensitivity, of the pure metabolic parameters tested}---blood oxygen cost, proximal flow, segment
...
remodeling: \chE{the branching exponent is predicted to shift} from the viscous attractor
...
reflections are physically absent---\chE{the theory would fail this falsification test}. Such an observation
