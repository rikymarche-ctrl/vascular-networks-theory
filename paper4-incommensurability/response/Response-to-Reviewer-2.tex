...
\bigskip
\noindent We thank Reviewer~2 for an exceptionally detailed and constructive
review. The four points raised have led to substantive additions that make the
theory's assumptions explicit, broaden and sharpen its empirical test, and
improve its accessibility. Below we reproduce each comment (paraphrased
faithfully from the report) and detail our response. \textbf{All changes
prompted by Reviewer~2 are typeset in \rtwo{red} in the highlighted copy of the
manuscript.}
...
further exposition there would be padding rather than clarification.
\emph{Location:} Sections~1--6 and~9, \rtwo{red}.

% --------------------------------------------------------------------
\bigskip
\hrule
\bigskip
\noindent\textbf{Closing.} We thank Reviewer~2 again: the manuscript is
substantially clearer and better bounded. Beyond the reviewer-driven changes
...
branching ratio, vs.\ $\beta_M$, the metabolic scaling exponent).
